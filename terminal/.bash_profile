...
# edit .bash_profile file in vscode
alias editbash='cd ~ ; code .bash_profile'

# open chrome
alias chrome='open http://www.google.com'
...
# '\h' adds the host (computer) name
# '\$(__git_ps1)' adds git-related stuff
# '\W' adds the name of the current directory
# '\w' adds the complete directory path

#   Change Prompt
#   ------------------------------------------------------------
    export PS1="________________________________________________________________________________\n$yellow\h$purple (\u) $green\$(__git_ps1)$blue \w \n$ $reset"

#   Set Paths
#   ------------------------------------------------------------
    # For custom installed binaries
...
alias lsl='ls -la -G'                       # Use a long listing format
